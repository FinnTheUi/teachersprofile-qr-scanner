        ...
        <div class="col-lg-8">
            <div class="card shadow-hover">
                <div class="card-header text-white gradient-header">
                    <h4 class="mb-0"><i class="fas fa-id-card me-2"></i>Teacher Profile</h4>
                </div>
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        ...
                        <p class="mb-0 fw-semibold">{{ $profile->office->college }}</p>
                            ...
                            <div class="profile-section">
                                ...
                                <div class="d-flex gap-2">
                                    @if(isset($profile->social_links['facebook']))
                                        <a href="{{ $profile->social_links['facebook'] }}" target="_blank" class="btn btn-outline-primary rounded-circle">
                                            <i class="fab fa-facebook-f"></i>
                                        </a>
                                    @endif
                                    @if(isset($profile->social_links['linkedin']))
                                        <a href="{{ $profile->social_links['linkedin'] }}" target="_blank" class="btn btn-outline-primary rounded-circle">
